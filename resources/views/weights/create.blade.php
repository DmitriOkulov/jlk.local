...
@section('content')
    ...
    <form method="POST" action="{{ route('weights.store') }}">
        ...
        <div class="form-group">
            ...
            <input id="weight" class="form-control{{ $errors->has('weight') ? ' is-invalid' : '' }}" name="weight" type="text" value="{{ old('weight') }}">
        ...
        <div class="form-group">
            ...
            <input id="left_triceps" class="form-control{{ $errors->has('left_triceps') ? ' is-invalid' : '' }}" name="left_triceps" type="text" value="{{ old('left_triceps') }}">
        ...
        <div class="form-group">
            ...
            <input id="right_triceps" class="form-control{{ $errors->has('right_triceps') ? ' is-invalid' : '' }}" name="right_triceps" type="text" value="{{ old('right_triceps') }}">
        ...
        <div class="form-group">
            ...
            <input id="waist" class="form-control{{ $errors->has('waist') ? ' is-invalid' : '' }}" name="waist" type="text" value="{{ old('waist') }}">
            @if ($errors->has('waist'))
        ...
        <div class="form-group">
            ...
            <input id="sides" class="form-control{{ $errors->has('sides') ? ' is-invalid' : '' }}" name="sides" type="text" value="{{ old('sides') }}">
            @if ($errors->has('sides'))
        ...
        <div class="form-group">
            ...
            <input id="left_hip" class="form-control{{ $errors->has('left_hip') ? ' is-invalid' : '' }}" name="left_hip" type="text" value="{{ old('left_hip') }}">
        ...
        <div class="form-group">
            ...
            <input id="right_hip" class="form-control{{ $errors->has('right_hip') ? ' is-invalid' : '' }}" name="right_hip" type="text" value="{{ old('right_hip') }}">
        ...
        <div class="form-group">
            ...
            <input id="left_calf" class="form-control{{ $errors->has('left_calf') ? ' is-invalid' : '' }}" name="left_calf" type="text" value="{{ old('left_calf') }}">
        ...
        <div class="form-group">
            ...
            <input id="right_calf" class="form-control{{ $errors->has('right_calf') ? ' is-invalid' : '' }}" name="right_calf" type="text" value="{{ old('right_calf') }}">
