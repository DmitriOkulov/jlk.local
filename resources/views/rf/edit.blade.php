...
<h1>Изменить RF лифтинг</h1>
    <form method="POST" action="{{ route('rf.update', $rf) }}">
        ...
        <div class="form-group">
            ...
            <input id="stomach" class="form-control{{ $errors->has('stomach') ? ' is-invalid' : '' }}" name="stomach" type="text" value="{{ old('stomach', $rf->stomach) }}" required>
        ...
        <div class="form-group">
            ...
            <input id="ass" class="form-control{{ $errors->has('ass') ? ' is-invalid' : '' }}" name="ass" type="text" value="{{ old('ass', $rf->ass) }}" required>
            @if ($errors->has('ass'))
        ...
        <div class="form-group">
            ...
            <input id="hips" class="form-control{{ $errors->has('hips') ? ' is-invalid' : '' }}" name="hips" type="text" value="{{ old('hips', $rf->hips) }}" required>
            @if ($errors->has('hips'))
